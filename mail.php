...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($text == null) {
        $text = 'Клиент не заполнил это поле, посчитал что это не обязательно )';
    }


    $subject = "Заявка с сайта";
    $message = "<h4>Имя клиента: $name</h4><h4>Телефон: $tel</h4><h4>Организация: $organ</h4><h4>Текст:$text</h4>";
